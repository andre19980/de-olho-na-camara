...
export type DeputadosFilterQuery = {
  __typename?: "Query";
  deputados: Array<{
    __typename?: "Deputado";
    id: number;
...
export const DeputadosFilterDocument = {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "nome" } },
                { kind: "Field", name: { kind: "Name", value: "siglaUf" } },
                { kind: "Field", name: { kind: "Name", value: "email" } },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "siglaPartido" },
                },
              ],
            },
          },
  ...
  DeputadosFilterQuery,
  DeputadosFilterQueryVariables
>;
export const DeputadoDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "Deputado" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "deputadoId" },
          },
          type: {
            kind: "NonNullType",
            type: {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "idLegislatura" },
                },
                { kind: "Field", name: { kind: "Name", value: "urlFoto" } },
                { kind: "Field", name: { kind: "Name", value: "email" } },
                { kind: "Field", name: { kind: "Name", value: "telefone" } },
              ],
            },
          },
        ],
...
} as unknown as DocumentNode<DeputadoQuery, DeputadoQueryVariables>;
