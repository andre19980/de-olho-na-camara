...
export type DeputadoResolvers<
  ContextType = DataSourceContext,
  ParentType extends
    ResolversParentTypes["Deputado"] = ResolversParentTypes["Deputado"],
> = {
...
> = {
  deputado?: Resolver<
    ResolversTypes["Deputado"],
    ParentType,
    ContextType,
    RequireFields<QueryDeputadoArgs, "id">
  >;
  deputados?: Resolver<
    Array<ResolversTypes["Deputado"]>,
    ParentType,
    ContextType,
    Partial<QueryDeputadosArgs>
  >;
};
